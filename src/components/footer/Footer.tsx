...
const Footer = () => {
    ...
    const footerLinks = [
        { src: youtube, alt: "엘리스트랙 youtube 바로가기", href:"https://www.youtube.com/@elice_official", className: styles.footer_sns_youtube},
        { src: instagram, alt: "엘리스트랙 instagram 바로가기", href:"https://www.instagram.com/elice.track.coding/", className: styles.footer_sns_instagram},
        { src: linkedin, alt: "엘리스트랙 linkedin 바로가기", 
        ...
        <div className={styles.footer_box}>
            <div className={styles.footer_ul_box}>
                <ul className={styles.footer_ul}>
                    <li className={styles.footer_li}><a href="https://legal.elice.io/policies/terms/2024-11-12" target='_blank' className={styles.footer_a}>서비스 이용약관</a></li>
                    <li className={styles.footer_li}><a href="https://legal.elice.io/policies/privacy/2024-06-20" target='_blank' className={styles.footer_a}>개인정보처리방침</a></li>
                </ul>
                <div className={styles.copyright_box}>
                    <p className={styles.footer_copyright}>Copyright ⓒ 2016 - 2024 E-Office, Inc. All Rights Reserved.</p>
                </div>
